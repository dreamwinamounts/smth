...
class Pizza():
    ...
    AVAILABLE_TOPPINGS = (
        ...
        Topping("Salami", 4.00),
        Topping("Ham", 3.50),
        Topping("Mozzarella", 1.50),
        Topping("Parmesan", 2.00),
        Topping("Champignon", 3.00),
        Topping("Olives", 2.50),
        Topping("Basillic", 0.50),
        Topping("Pineapple", 3.50),
        Topping("Hallapenio", 3.50),
        Topping("Chiken", 4.50),
        Topping("Bell pepper", 1.50),
        Topping("Onion"),
        Topping("Anchovy", 6.00),
        Topping("Shrimp", 5.50)
    )
